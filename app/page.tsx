export default function Home() {
  return <main>
    ...
    <section className="story" id="story"><div><p className="eyebrow">The beginning</p><h2>It started with a garden bed and an overnight surprise.</h2></div><p>We planted something new. By morning, it was gone. The likely culprit? A bold bush turkey from the nearby bushland. Rather than simply guessing, this project asks a better question: what is actually happening out there at night?</p><aside>“The garden is part of their neighbourhood too.”</aside></section>
